      ...
      <div style={containerStyles}>
        <header style={headerStyles}>
          ...
          <p style={subtitleStyles}>
            Visually understand the difference between CSS spacing properties by
          ...
          <div style={controlPanelStyles}>
            <div style={controlGroupStyles}>
              <label style={controlLabelStyles}>
                <span style={{ color: theme.colors.primary }}>Padding</span>
              ...
              >
                Space inside the container (orange area)
              </p>
              <input
                type="range"
                min="0"
            ...
            <div style={controlGroupStyles}>
              <label style={controlLabelStyles}>
                <span style={{ color: "#0066CC" }}>Margin</span>
                <span>{margin}px</span>
              </label>
              <p
                style={{
              ...
              >
                Space around each item (blue area)
              </p>
              <input
                type="range"
                min="0"
            ...
            <div>
              ...
              >
                Space between items in a flex/grid container
              </p>
              <input
                type="range"
                min="0"
